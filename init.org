...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (25877 21144 251215 0) :init (25877 21144 251204 0) :config (25877 21144 251054 0) :config-secs (0 0 266 0) :init-secs (0 0 584 0) :use-package-secs (0 0 662 0)))
