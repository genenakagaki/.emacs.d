...
[:main.prose.mx-auto
   ...
   [:<>
    ...
    [:div
     [:div.section
      ...
      nil
      [:p
       [:a {:src "file:../images/2022-07-30_09-30-30_screenshot.png"}]
       "\n"]
      ...
      nil
      [:p
       [:a {:src "file:../images/2022-07-30_09-31-02_screenshot.png"}]
       "\n"]
      [:p
 ...
 [:<>
  [:h1 "Setting up the static website"]
  [:div
   [:div.section
    [:p
   ...
   [:<>
    ...
    [:div
     [:div.section
      ...
      nil
      [:p
       [:a {:src "file:../images/2022-08-09_09-02-51_screenshot.png"}]
       "\n"]
      [:p
       "I specified it to be "
       [:code "gene-website"]
       ",\n so "
       [:code "!Sub '${AWS::StackName}-root-bucket'"]
       "is going to be evaluated as "
       [:code "gene-website-root-bucket"]
       ".\n"]]]]
   [:<>
    [:h2 "Setting up a CloudFront Distribution"]
    [:div
     [:div.section
      [:p
      ...
      nil
      [:p
       [:a {:src "file:../images/2022-07-30_09-32-11_screenshot.png"}]
       "\n"]
      [:p
       "I broke it down into 3 parts to make it easier to understand.\n"]]
     [:<>
      [:h3 "Part 1: Create the distribution!"]
      [:div
       [:div.section
        [:p
     ...
     [:<>
      [:h3 "Part 2: Set up S3 as the origin"]
      [:div
       [:div.section
        [:p
     ...
     [:<>
      [:h3 "Part 3: Set up the default behavior"]
      [:div
       [:div.section
        [:p
 ...
 [:<>
  ...
  [:div
    ...
    [:div
     [:div.section
      ...
      [:p
       ...
       [:a
        {:src "id:FBA01C88-7035-402E-B742-E749F4750AEE"}
        "Hosted Zone"]
       ". For the "
       [:a
   ...
   [:<>
    [:h2 "Setting up HTTPS requests to CloudFront"]
    [:div
     [:div.section
      [:p
       "First I needed an "
      ...
      [:p
       "The "
       [:a
        {:src "id:12445406-CEC1-4F7F-B548-9CCB7F6E03C9"}
        "Parameter"]
      ...
      nil
      [:p
       [:a {:src "file:../images/2022-08-09_08-53-08_screenshot.png"}]
       "\n"]
      [:p
