...
* [`src/genenakagaki/blog/frontend/`](src/genenakagaki/blog/frontend/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/genenakagaki/blog/frontend/core.cljs): contains the SPA entry point, `init`
* [`test/genenakagaki/blog/frontend/`](test/genenakagaki/blog/frontend/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `genenakagaki/blog/frontend` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/genenakagaki/blog/frontend/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns genenakagaki.blog.frontend.example
  (:require [genenakagaki.blog.frontend.config :as config])
